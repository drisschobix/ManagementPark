...
<div class="container">
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Editer Véhicules</a></li>
  </ul>
...
<div class="row">
  ...
  <div class="tab-content">
	...
	<br><br>
   <form class="Myform" action="/ManagementPark/EditVehicleSubmition/${Vehicle.getID_Vehicle()}"  method="post"  >

   <div class="form-group">
<label for="Nbr-places">ID:</label>
<div style="display: none;">
  <input type="number" class="form-control" id="ID_Vehicle" name="ID_Vehicle" value="${Vehicle.getID_Vehicle()}">
